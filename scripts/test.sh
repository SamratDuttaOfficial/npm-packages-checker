...
MAIN_SOURCES="src/common.c src/csv_parser.c src/npm_analyzer.c src/vulnerability_checker.c src/report_generator.c src/cli.c"

# Test source files
TEST_SOURCES="tests/test_framework.c tests/mock_data/npm_mock.c"
UNIT_TEST_SOURCES="tests/unit/test_csv_parser.c tests/unit/test_vulnerability_checker.c tests/unit/test_report_generator.c tests/unit/test_cli.c"
INTEGRATION_TEST_SOURCES="tests/integration/test_npm_analyzer.c tests/integration/test_full_workflow.c tests/integration/test_cli_integration.c tests/integration/test_gui_integration.c"
E2E_TEST_SOURCES="tests/e2e/test_end_to_end.c tests/e2e/test_cli_e2e.c"
